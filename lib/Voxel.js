...
function Voxel() {
    ...
    function angleFromLightSource(x, y, z, plane) {
        var rotMatrix = generateRotationMatrix(parentScene.getRotationX(), -parentScene.getRotationY(), parentScene.getRotationZ());
        var point = {x, y, z};
        ...
        var distance = sqrt(pow(rotatedPoint.x, 2) + pow(rotatedPoint.y, 2) + pow(rotatedPoint.z, 2));
        var direction = abs(plane.C) === 1 ? plane.C * rotatedPoint.z : (Math.abs(plane.B) === 1 ? plane.B * rotatedPoint.y : plane.A * rotatedPoint.x);
        var angle = asin(abs(rotatedPoint.x * plane.A + rotatedPoint.y * plane.B + rotatedPoint.z * plane.C) / (sqrt(pow(rotatedPoint.x, 2) + pow(rotatedPoint.y, 2) + pow(rotatedPoint.z, 2))));
    ...
    function rotate(point, rotMatrix) {
        ...
        var rotated = multiplyMatrices(rotMatrix, columnVector);
        return {
            x: rotated[0][0],
            y: rotated[1][0],
            z: rotated[2][0]
